import { Close, DarkModeOutlined, LightModeOutlined, NotificationsNoneOutlined, Search } from '@mui/icons-material'
...
const NavbarHorizontal = () => {
    ...
    const handleDarkModeClick = () => {
        if (darkMode) {
            ...
            localStorage[storage.theme] = 'light'
        } else {
        ...
        >
            <div className='h-[70px] max-w-[95%] px-6 bg-transparent mx-auto flex items-center justify-between'>
                ...
                <div className='flex items-center'>
                    <span className='inline-block text-4xl font-light dark:text-white cursor-pointer'>Dashboard</span>
                </div>
                {/* right */}
